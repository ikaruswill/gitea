...
RUN mkdir -p /app/gitea \
    ...
    && curl -sLo /app/gitea/gitea https://github.com/go-gitea/gitea/releases/download/${GITEA_VERSION}/gitea-${GITEA_VERSION#v}-${BINARY_OS}-${BINARY_ARCH} \
    && curl -sLo /app/gitea/gitea.asc https://github.com/go-gitea/gitea/releases/download/${GITEA_VERSION}/gitea-${GITEA_VERSION#v}-${BINARY_OS}-${BINARY_ARCH}.asc \
